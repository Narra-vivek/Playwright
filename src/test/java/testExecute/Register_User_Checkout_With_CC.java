...
public class Register_User_Checkout_With_CC {
 
	@Test
	public void Validating_Register_Checkout_with_CC () throws Exception {
...
//	@Description()
		...
		Allure.step("Navigated to the Hydroflask Home Page");
